...
export default function TutorialAdminForgotPasswordPage() {
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      setTimeout(() => router.push("/tutorials/admin/login"), 2000);
    } catch (e: any) {
      ...
      <div className="relative w-full max-w-md">
        <div className="flex justify-center mb-8">
          <div className="inline-flex flex-col items-center gap-2">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center shadow-xl shadow-blue-500/30 text-xl">
              🔑
            </div>
            <div className="text-center">
              <h1 className="text-xl font-black text-white">Reset Tutorial Admin Password</h1>
          ...
          {step === "email" ? (
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 disabled:opacity-50 text-white font-bold py-3 rounded-xl transition"
              >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  maxLength={6}
                  className="w-full bg-white/5 border border-white/10 text-white placeholder-white/20 rounded-xl px-4 py-3 outline-none focus:border-blue-500 transition text-center tracking-[0.5em] text-xl font-bold"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 text-white placeholder-white/20 rounded-xl px-4 py-3 outline-none focus:border-blue-500 transition text-sm"
                />
              </div>
              <div>
        ...
        <p className="text-center mt-5">
          <Link href="/tutorials/admin/login" className="text-blue-400 hover:text-blue-300 text-sm transition">
            ← Back to Tutorial Admin login
          </Link>
        </p>
      </div>
    </div>
